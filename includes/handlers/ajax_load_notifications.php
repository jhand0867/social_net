...
$notification_obj = new Message( $con, $_REQUEST['userLoggedIn']);
...
foreach ($convos as $user) {
	...
	<div>
		...
		<div class='comvo_msg' style='top: 0px; 
		   ...
		   $notification_obj->getLastMessage($user)['text'] . "<br><span style='font-size: 12; color: #007bff;'>"
		        . $notification_obj->getLastMessage($user)['time'] . "</span></p>
		</div>
	</div>
	<hr>
	";
